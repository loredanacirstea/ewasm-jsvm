...
const initializeImports = (
    ...
    const ethereum = {
            useGas: function (amount_i64) {
                ...
                logger.debug('useGas', [amount_i64], [], getCache());
            },
            getAddress: function (resultOffset_i32ptr) {
                ...
                logger.debug('getAddress', [resultOffset_i32ptr], [address], getCache());
            },
            // result is u128
            getExternalBalance: function (addressOffset_i32ptr, resultOffset_i32ptr) {
                ...
                logger.debug('getExternalBalance', [addressOffset_i32ptr, resultOffset_i32ptr], [balance], getCache());
            },
            ...
            getBlockHash: function (number_i64, resultOffset_i32ptr) {
                ...
                logger.debug('getBlockHash', [number_i64, resultOffset_i32ptr], [result, hash], getCache());
                return result;
            },
            ...
            call: function (
                ...
                logger.debug('call', [gas_limit_i64, addressOffset_i32ptr_address, valueOffset_i32ptr_u128, dataOffset_i32ptr_bytes, dataLength_i32], [result], getCache());
                return result;
            },
            callDataCopy: function (resultOffset_i32ptr_bytes, dataOffset_i32, length_i32) {
                ...
                logger.debug('callDataCopy', [resultOffset_i32ptr_bytes, dataOffset_i32, length_i32], [result], getCache());
                return result;
            },
            // returns i32
            getCallDataSize: function () {
                const result = jsvm_env.getCallDataSize();
                logger.debug('getCallDataSize', [], [result], getCache());
                return result;
            },
            callDataLoad: function(dataOffset) {
                const result = jsvm_env.callDataLoad(toBN(dataOffset));
                logger.debug('callDataLoad', [dataOffset], [result], getCache());
                return result;
            },
            // result i32 Returns 0 on success, 1 on failure and 2 on revert
            callCode: function (
                ...
                logger.debug('callCode', [gas_limit_i64, addressOffset_i32ptr_address, valueOffset_i32ptr_u128, dataOffset_i32ptr_bytes, dataLength_i32], [result], getCache());
                return result;
            },
            // result i32 Returns 0 on success, 1 on failure and 2 on revert
            callDelegate: function (
                ...
                logger.debug('callDelegate', [gas_limit_i64, addressOffset_i32ptr_address, dataOffset_i32ptr_bytes, dataLength_i32], [result], getCache());
                return result;
            },
            // result i32 Returns 0 on success, 1 on failure and 2 on revert
            callStatic: function (
                ...
                logger.debug('callStatic', [gas_limit_i64, addressOffset_i32ptr_address, dataOffset_i32ptr_bytes, dataLength_i32], [result], getCache());
                return result;
            },
            storageStore: function (pathOffset_i32ptr_bytes32, valueOffset_i32ptr_bytes32) {
                ...
                logger.debug('storageStore', [pathOffset_i32ptr_bytes32, valueOffset_i32ptr_bytes32], [key, value], getCache());
            },
            storageLoad: function (pathOffset_i32ptr_bytes32, resultOffset_i32ptr_bytes32) {
                ...
                logger.debug('storageLoad', [pathOffset_i32ptr_bytes32, resultOffset_i32ptr_bytes32], [value], getCache());
            },
            getCaller: function (resultOffset_i32ptr_address) {
                ...
                logger.debug('getCaller', [resultOffset_i32ptr_address], [address], getCache());
            },
            getCallValue: function (resultOffset_i32ptr_u128) {
                ...
                logger.debug('getCallValue', [resultOffset_i32ptr_u128], [value], getCache());
            },
            codeCopy: function (resultOffset_i32ptr_bytes, codeOffset_i32, length_i32) {
                ...
                logger.debug('codeCopy', [resultOffset_i32ptr_bytes, codeOffset_i32, length_i32], [result], getCache());
            },
            // returns i32 - code size current env
            getCodeSize: function() {
                const result = jsvm_env.getCodeSize();
                logger.debug('getCodeSize', [], [result], getCache());
                return result;
            },
            ...
            getBlockCoinbase: function(resultOffset_i32ptr_address) {
                ...
                logger.debug('getBlockCoinbase', [resultOffset_i32ptr_address], [value], getCache());
            },
            // result i32 Returns 0 on success, 1 on failure and 2 on revert
            create: function (
                valueOffset_i32ptr_u128,
            ...
            getBlockDifficulty: function (resulltOffset_i32ptr_u256) {
                ...
                logger.debug('getBlockDifficulty', [resulltOffset_i32ptr_u256], [value], getCache());
            },
            ...
            getExternalCodeSize: function (addressOffset_i32ptr_address) {
                ...
                logger.debug('getExternalCodeSize', [addressOffset_i32ptr_address], [result], getCache());
                return result;
            },
            // result gasLeft i64
            getGasLeft: function () {
                const result = jsvm_env.getGasLeft();
                logger.debug('getGasLeft', [], [result], getCache());
                return result;
            },
            // result blockGasLimit i64
            getBlockGasLimit: function () {
                const result = jsvm_env.getBlockGasLimit();
                logger.debug('getBlockGasLimit', [], [result], getCache());
                return result;
            },
            getTxGasPrice: function (resultOffset_i32ptr_u128) {
                ...
                logger.debug('getTxGasPrice', [resultOffset_i32ptr_u128], [value], getCache());
            },
            log: function (
                dataOffset_i32ptr_bytes,
                dataLength_i32,
            ...
            getBlockNumber: function () {
                ...
                logger.debug('getBlockNumber', [], [result], getCache());
                return result;
            },
            ...
            getReturnDataSize: function () {
                ...
                logger.debug('getReturnDataSize', [], [result], getCache());
                return result;
            },
            returnDataCopy: function (resultOffset_i32ptr_bytes, dataOffset_i32, length_i32) {
                ...
                logger.debug('returnDataCopy', [resultOffset_i32ptr_bytes, dataOffset_i32, length_i32], [], getCache());
            },
            ...
            getBlockTimestamp: function () {
                ...
                logger.debug('getBlockTimestamp', [], [result], getCache());
                return result;
            }
    }
